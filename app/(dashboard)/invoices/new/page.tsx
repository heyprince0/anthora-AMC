...
export default function NewInvoicePage() {
  ...
  const handleSave = async () => {
    ...
    setSaving(true)
    try {
      // Generate invoice_no based on org scope
      ...
      const nextNumber = ((existingInvoices?.length || 0) + 1).toString().padStart(3, "0")
      ...
      if (!newInvoiceId) throw new Error("Failed to get invoice ID")
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Prepare a new invoice for your customer</p>
          </div>
        </div>
